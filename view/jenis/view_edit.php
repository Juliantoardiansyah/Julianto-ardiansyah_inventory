...
<body>
    <div class="container">
        ...
        $id_barang= $_GET['id'];
        $query = mysqli_query($conn, "SELECT * FROM barang WHERE id_jenis='$id'");
        ...
        <form action="proses_edit.php?id=<?php echo $result['id_barang']; ?>" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="varchar" class="form-control" name="nama_jenis" value="<?php echo $result['nama jenis']; ?>" id="exampleInputPassword1">
            </div>
